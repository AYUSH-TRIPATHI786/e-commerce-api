	...
	var A,
		...
		C = (n.fn.init = function (a, b, c) {
			...
			if (((c = c || A), 'string' == typeof a)) {
				if (
					((e =
						'<' === a.charAt(0) && '>' === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : B.exec(a)),
					!e || (!e[1] && b))
				)
		...
		style: function (a, b, c, d) {
			if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
				var e,
					...
					i = a.style;
				if (
					((b = n.cssProps[h] || (n.cssProps[h] = bb(h) || h)), (g = n.cssHooks[b] || n.cssHooks[h]), void 0 === c)
				)
		...
		n.each(n.expr.match.bool.source.match(/\w+/g), function (a, b) {
			...
			(yb && xb) || !wb.test(b)
				? (vb[b] = function (a, b, d) {
						var e, f;
						return (
							d || ((f = vb[b]), (vb[b] = e), (e = null != c(a, b, d) ? b.toLowerCase() : null), (vb[b] = f)), e
						);
				  })
				: (vb[b] = function (a, b, c) {
